...
const handleSubmit = async () => {
    ...
    await createCompany(name.value, email.value, password.value)
        .then(async () => {
            done.value = true;
        })
        .catch((error) => {
        ...
        <template #default="{ closeDialog }">
            <Transition name="fade" mode="out-in" appear>
                <div class="w-full" v-if="!done">
                    <h1 class="text-2xl font-semibold">Add Company</h1>
                    <form
                        id="add-company-form"
                    ...
                    >
                        ...
                        <label class="self-start font-semibold">Password</label>
                        <div class="w-full mb-4">
                            <input
                                type="password"
                                class="input"
                ...
                >
                    ...
                    <div class="w-full flex flex-col gap-2">
                        ...
                        <p class="text-lg">Company addded Successfully</p>
                        <IHButton
                            class="w-full mt-4"
                            type="button"
                            @click="closeDialog()"
